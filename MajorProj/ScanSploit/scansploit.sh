...
echo -e " "
echo -n -e $red'  Enter your choice (1-89) >>> '; tput sgr0 #insert your choice
         read vuln
      if test $vuln == '1'
        then
        echo
...
echo ""
  ...
  echo -e $white"	[$okegreen"08"$white]$cyan  BACK  "
	echo -e 	" "
  echo -n -e $red'  Enter your choice from given options >>> '; tput sgr0 #insert your choice
      read Scanning
			if test $Scanning == '1'
				then
				echo
...
echo -e $cyan"    Kali Linux          $white":" $red kali.org "
echo -e $cyan ""
echo -e $okegreen"    =========================================================    ";
		echo -e $white " "
